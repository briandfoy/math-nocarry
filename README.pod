...
CPAN web interfaces, such as L<CPAN Search|http://search.cpan.org/dist/Math-NoCarry> or 
L<MetaCPAN|http://www.metacpan.org/module/Math::NoCarry>:

=over 4

=item *	L<http://search.cpan.org/dist/Math-NoCarry>

=item *	L<http://www.metacpan.org/module/Math::NoCarry>
